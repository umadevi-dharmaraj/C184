				...
				<View style={styles.framesContainer}>
					<View style={styles.categoryContainer}>
						<TouchableOpacity style={this.state.selected="regular" ? styles.categoryBoxSelected: styles.categoryBox}
							onPress={()=> this.state.selected({selected:"regular"})}>
							<Text>Regular</Text>
						</TouchableOpacity>
						<TouchableOpacity style={this.state.selected="wayfarer" ? styles.categoryBoxSelected: styles.categoryBox}
							onPress={()=> this.state.selected({selected:"wayfarer"})}>
							<Text>Wafarer</Text>
						</TouchableOpacity>
						<TouchableOpacity style={this.state.selected="rimless" ? styles.categoryBoxSelected: styles.categoryBox}
							onPress={()=> this.state.selected({selected:"rimless"})}>
							<Text>Rimless</Text>
						</TouchableOpacity><TouchableOpacity style={this.state.selected="round" ? styles.categoryBoxSelected: styles.categoryBox}
							onPress={()=> this.state.selected({selected:"round"})}>
							<Text>Round</Text>
						</TouchableOpacity>
						<TouchableOpacity style={this.state.selected="aviator" ? styles.categoryBoxSelected: styles.categoryBox}
							onPress={()=> this.state.selected({selected:"aviator"})}>
							<Text>Aviator</Text>
						</TouchableOpacity>
